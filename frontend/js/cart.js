...
for (let product of cart) {
  ...
  fetch(`http://localhost:3000/api/products/${productId}`)
    ...
    .then((productDetails) => {
      ...
      productQuantityPicked.setAttribute("max", 20);
